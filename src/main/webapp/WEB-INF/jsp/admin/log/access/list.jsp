	...
	<script type="text/javascript">
		...
		$(document).ready(function(){
			...
			$("#btnExcel").click(function(){
				...
				axios({
					method: 'GET',
					url: "<c:url value='/admin/log/access/excel.do' />",
					params: param,
				...
				.then(function(response){
					...
					var fileName = "접속로그_"+param.startDate+"-"+param.endDate +'.xlsx';
			...
			$("#btnModalRemove").click(function(){
				...
				if(confirm(startDate+ '와 '+endDate+'일 사이의 접속 로그가 삭제됩니다.\n삭제시 복구 할 수 없습니다.\n접속 로그를 삭제 하시겠습니까?')){
					...
					axios.post("<c:url value='/admin/log/access/removes.delete' />", param)
					  .then(function (res) {
				    	alert(res.data.result+'건의 접속 로그가 삭제 되었습니다.');
				    	location.href="<c:url value='/admin/log/access/index.do' />";
					  })
