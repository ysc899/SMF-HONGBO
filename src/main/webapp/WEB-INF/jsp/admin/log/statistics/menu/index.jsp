...
<html>
				...
				<div class="notice_area" style="min-height:150px;">
					...
					<div class="select_box">
						<form id="searchForm" method="get">
								...
								<span style="margin-top:13px;float:right;">조회 일</span>
						</form>
					</div>
				</div>
				<!--/notice_area End-->
	...
	<script type="text/javascript">
		...
		function search(){
			...
			axios.get("<c:url value='/admin/log/statistics/menu/static.json' />",{
				params: param
			}).then(function (res) {
		...
		function viewChart(data){
			...
			_.each(data, function(d){
				idx++;
				menus.push(d.menuName);
				datas.push(d.cnt);
				backgroundColors.push(COLORS[idx % 9]);
			});
		...
		$(document).ready(function(){
			...
			$("#btnModalExcel").click(function(){
				...
				axios({
					method: 'GET',
					url: "<c:url value='/admin/log/statistics/menu/staticExcel.do' />",
					params: param,
				...
				.then(function(response){
					...
					var fileName = "메뉴별 접속 통계 "+startDate+"-"+endDate +'.xlsx';
