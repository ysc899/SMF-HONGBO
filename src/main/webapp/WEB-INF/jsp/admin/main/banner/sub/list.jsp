...
// 				location.href="<c:url value='/admin/main/banner/sub/" + seq + ".view' />";
				$("#searchForm").attr('action', "<c:url value='/admin/main/banner/sub/" + seq + ".view' />").submit();
...
// 					location.href="<c:url value='/admin/main/banner/sub/add.write' />";
					$("#searchForm").attr('action', "<c:url value='/admin/main/banner/sub/add.write' />").submit();
