...
<html>
	...
	<script type="text/javascript">
		...
		$(document).ready(function(){
			...
			$("#editForm").validate({
				rules:{
					title: {required:true, maxlength:40, minlength:2},
...
// 					url: {url:true}
				...
				submitHandler: function(form) {
					...
					axios.post("<c:url value='/admin/main/banner/sub/editSubBanner.edit' />", fd,{headers : {
						'Content-Type' : 'multipart/form-data'
					}})
					  .then(function (res) {
					    if(res.data.result > 0){
					    	alert('수정 되었습니다.');
//  					    	location.href="<c:url value='/admin/main/banner/sub/${result.seq}.view' />";
							$("#hiddenForm").attr('action', "<c:url value='/admin/main/banner/sub/${result.seq}.view' />").submit();
