				...
				<div class="notice_area">
					...
					<table>
						...
						<tbody>
							...
							<tr>
								<th>이미지</th>
								<td colspan="3"><img src='<c:out escapeXml="false" value="${result.fileContent }"/>' style="width:auto;"></td>
							</tr>
							<tr>
								<th>내용</th>
	...
	<script type="text/javascript">
		...
		$(document).ready(function(){
			...
			if(seq == ''){
				...
				location.href="<c:url value='/admin/main/banner/sub/index.do' />";
			}
			...
			if(writeFlag){
				...
				$("._remove").click(function(){
					if(confirm('서브 베너 정보를 삭제 하시겠습니까?')){
						...
						axios.post("<c:url value='/admin/main/banner/sub/"+ seq +".delete' />")
						  .then(function (res) {
						    if(res.data.result){
						    	alert('삭제 되었습니다.');
// 						    	history.back();
...
// 					location.href="<c:url value='/admin/main/banner/sub/"+ seq +".edit' />";
					$("#hiddenForm").attr('action', "<c:url value='/admin/main/banner/sub/"+ seq +".edit' />").submit();
