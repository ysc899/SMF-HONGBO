...
<html>
	...
	<script type="text/javascript">
		...
		$(document).ready(function(){
			...
			if(seq == ''){
				alert('존재하지 않는 롤링정보 입니다.');
				location.href="<c:url value='/admin/main/rolling/index.do' />";
...
// 				history.back();
				$("#hiddenForm").attr('action', "<c:url value='/admin/main/rolling/index.do' />").submit();
			...
			if(writeFlag){
				...
				$("._remove").click(function(){
					if(confirm('롤링 정보를 삭제 하시겠습니까?')){
						
						axios.post("<c:url value='/admin/main/rolling/"+ seq +".delete' />")
						  .then(function (res) {
						    if(res.data.result){
						    	alert('삭제 되었습니다.');
// 						    	history.back();
...
// 					location.href="<c:url value='/admin/main/rolling/"+ seq +".edit' />";
					$("#hiddenForm").attr('action', "<c:url value='/admin/main/rolling/"+ seq +".edit' />").submit();
