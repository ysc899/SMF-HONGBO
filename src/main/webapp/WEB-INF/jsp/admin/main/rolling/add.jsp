						...
						<table>
							...
							<tbody>
								...
								<tr>
									<th>내용</th>
									<td colspan="3">
										<input type="text" class="form-control text_title" name="content" placeholder="등록될 롤링 내용을 입력해주세요." id="content">
									</td>
								</tr>
								<tr>
									<th>링크 URL</th>
		...
		$(document).ready(function(){
			...
			$("#addForm").validate({
				...
				submitHandler: function(form) {
					...
					axios.post("<c:url value='/admin/main/rolling/addRolling.write' />", param)
					  .then(function (res) {
					    if(res.data.result > 0){
					    	alert('등록 되었습니다.');
//  					    	location.href="<c:url value='/admin/main/rolling/" + res.data.result + ".view' />";
							$("#hiddenForm").attr('action', "<c:url value='/admin/main/rolling/" + res.data.result + ".view' />").submit();
