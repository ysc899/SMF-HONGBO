						...
						<div class="select_box">
							...
							<form id="searchForm" method="get">
								...
								<select class="kind" name="searchOption" id="optSearch">
									...
									<option value="name">게시판 명</option>
...
// 				location.href="<c:url value='/admin/board/manage/" + seq + ".view' />";
				$("#searchForm").attr('action', "<c:url value='/admin/board/manage/" + seq + ".view' />").submit();
...
// 					location.href="<c:url value='/admin/board/manage/add.write' />";
					$("#searchForm").attr('action', "<c:url value='/admin/board/manage/add.write' />").submit();
