	...
	<body>
		...
		<div id="wrap">
			...
			<form id="hiddenForm" method="get">
				<input type="text" name="searchOption" value="<c:out value='${sparam.searchOption}'/>"/>
				<input type="text" name="searchKeyword" value="<c:out value='${sparam.searchKeyword}'/>"/>
				<input type="text" name="currentPage" value="<c:out value="${sparam.currentPage }"/>"/>
				<input type="text" id="masterSeq" value="${masterSeq}"/>
			</form>
			</div>
			<!--//container End-->
		...
		$(document).ready(function(){
			...
			$("#addForm").validate({
				...
				submitHandler: function(form) {
					...
					axios.post("<c:url value='/admin/board/integrated/${masterSeq}/addBoardIntegrated.write' />", fd,{headers : {
...
//  							location.href="<c:url value='/admin/board/integrated/${masterSeq}/" + res.data.result + ".view' />";
							$("#hiddenForm").attr('action', "<c:url value='/admin/board/integrated/${masterSeq}/" + res.data.result + ".view' />").submit();
...
// 				history.back();
				$("#hiddenForm").attr('action', "<c:url value='/admin/board/integrated/${masterSeq}/index.do' />").submit();
