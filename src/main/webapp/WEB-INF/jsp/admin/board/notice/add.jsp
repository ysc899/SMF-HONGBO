		...
		<div id="wrap">
			...
			<div id="container">
				...
				<div class="notice_area">
					<form id="addForm">
						<sec:csrfInput />
						<h1><img src="<c:url value='/admin/img/menu.svg'/>" alt="메뉴아이콘">공문 등록</h1>
						<table>
							<colgroup>
								<col width="100px;"/>
								<col width="400px;"/>
							...
							<tbody>
								...
								<tr>
									<th>공문번호</th>
									<td colspan="3">
										<input type="text" class="form-control text_title" name="noticeNumber" placeholder="등록될 공문번호를 입력해주세요." id="noticeNumber"/>
									</td>
								</tr>
								<tr>
									<th>타이틀</th>
...
// 				lang: 'en-US',
			...
			$("#addForm").validate({
				...
				submitHandler: function(form) {
					...
					axios.post("<c:url value='/admin/board/notice/addNotice.write' />", fd,{headers : {
						'Content-Type' : 'multipart/form-data'
					}})
					  .then(function (res) {
...
//  					    	location.href="<c:url value='/admin/board/notice/" + res.data.result + ".view' />";
							$("#hiddenForm").attr('action', "<c:url value='/admin/board/notice/" + res.data.result + ".view' />").submit();
