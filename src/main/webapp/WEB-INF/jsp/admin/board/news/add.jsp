						...
						<table>
							...
							<tbody>
								...
								<tr>
									...
									<td>
										<div class="input-group date">
										    <input type="text" class="form-control _datepicker" name="popupStartDate" autocomplete="off" id="startDate">
									...
									<td>
										<div class="input-group date">
										    <input type="text" class="form-control _datepicker" name="popupEndDate" autocomplete="off" id="endDate">
										    <div class="input-group-addon">
										        <span class="glyphicon glyphicon-th"></span>
										    </div>
										</div>
								...
								<tr>
									<th>좌측좌표</th>
									<td>
										<input type="text" class="form-control text_title" name="popupLeftPosition" id="popupLeftPosition" style="width:300px;">
									</td>
									<th>상단좌표</th>
									<td>
										<input type="text" class="form-control text_title" name="popupTopPosition" id="popupTopPosition" style="width:300px;">
									</td>
								</tr>
								<tr>
									<th>내용</th>
								...
								<c:if test="${masterSeq == 2}">
									<tr>
										<th>검사코드</th>
										<td>
											<input type="text" placeholder="검사 코드를 검색 해주세요." style="width: 400px;" id="srchOnClickGcd" disabled="disabled"/>
											<input type="hidden" name="oneClickGcd" id="oneClickGcd" >
											<input type="hidden" name="oneClickGnm" id="oneClickGnm" >
											&nbsp;&nbsp;&nbsp;&nbsp;
		...
		$(document).ready(function(){
			...
			$("#addForm").validate({
				...
				submitHandler: function(form) {
					...
					axios.post("<c:url value='/admin/board/news/${masterSeq}/addBoardIntegrated.write' />", fd,{headers : {
						'Content-Type' : 'multipart/form-data'
					}})
					  .then(function (res) {
						if(res.data.result > 0){
							alert('등록 되었습니다.');
//  							location.href="<c:url value='/admin/board/integrated/${masterSeq}/" + res.data.result + ".view' />";
							$("#hiddenForm").attr('action', "<c:url value='/admin/board/news/${masterSeq}/" + res.data.result + ".view' />").submit();
