...
// 				location.href="<c:url value='/admin/board/integrated/${masterSeq}/" + seq + ".view' />";
				$("#searchForm").attr('action', "<c:url value='/admin/board/news/${masterSeq}/" + seq + ".view' />").submit();
...
// 					location.href="<c:url value='/admin/board/integrated/${masterSeq}/add.write' />";
					$("#searchForm").attr('action', "<c:url value='/admin/board/news/${masterSeq}/add.write' />").submit();
