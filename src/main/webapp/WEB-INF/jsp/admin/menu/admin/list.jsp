		...
		<div id="wrap">
			...
			<div id="container">
				...
				<div class="notice_area">
					<h1><img src="<c:url value='/admin/img/menu.svg'/>" alt="메뉴아이콘">관리자 메뉴 관리</h1>
...
// 				location.href="<c:url value='/admin/menu/admin/" + seq + ".view' />";
				$("#searchForm").attr('action', "<c:url value='/admin/menu/admin/" + seq + ".view' />").submit();
...
// 					location.href="<c:url value='/admin/menu/admin/add.write' />";
					$("#searchForm").attr('action', "<c:url value='/admin/menu/admin/add.write' />").submit();
