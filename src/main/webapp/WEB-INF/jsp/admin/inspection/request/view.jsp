...
<html>
	...
	<script type="text/javascript">
		...
		$(document).ready(function(){
			...
			if(seq == ''){
				alert('존재하지 않는 검사의뢰서 입니다.');
				location.href="<c:url value='/admin/inspection/request/index.do' />";
			}
...
// 				history.back();
			...
			if(writeFlag){
				...
				$("._remove").click(function(){
					if(confirm('검사의뢰서 정보를 삭제 하시겠습니까?')){
						
						axios.post("<c:url value='/admin/inspection/request/"+ seq +".delete' />")
						  .then(function (res) {
						    if(res.data.result){
						    	alert('삭제 되었습니다.');
// 						    	history.back();
...
// 					location.href="<c:url value='/admin/inspection/request/"+ seq +".edit' />";
					$("#hiddenForm").attr('action', "<c:url value='/admin/inspection/request/"+ seq +".edit' />").submit();
