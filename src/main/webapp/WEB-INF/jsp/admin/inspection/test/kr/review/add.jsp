...
<!-- 								<input type="text" name="f010gcd" value="" style="width: 100%;" placeholder="검사코드를 입력해주세요."/> -->
							...
							<tr>
								<th class="th1">url</th>
								<td colspan="3"><input type="text" class="form-control text_title" name="t001url" id="t001url"></td>
							</tr>
...
// 					f010gcd: {required:true, maxlength:5},
				...
				submitHandler: function(form) {
					...
					axios.post("<c:url value='/admin/inspection/test/kr/review/addInsp.write' />", param)
					  .then(function (res) {
					    if(res.data.result){
