...
// 				location.href="<c:url value='/admin/promotion/image/" + seq + ".view' />";
				$("#searchForm").attr('action', "<c:url value='/admin/promotion/image/" + seq + ".view' />").submit();
...
// 					location.href="<c:url value='/admin/promotion/image/add.write' />";
					$("#searchForm").attr('action', "<c:url value='/admin/promotion/image/add.write' />").submit();
