	...
	<script type="text/javascript">
		...
		$(document).ready(function(){
			...
			if(seq == ''){
				...
				location.href="<c:url value='/admin/promotion/image/index.do' />";
			}
			...
			if(writeFlag){
				...
				$("._remove").click(function(){
					if(confirm(title + ' 홍보영상을 삭제 하시겠습니까?')){
						...
						axios.post("<c:url value='/admin/promotion/image/"+ seq +".delete' />")
						  .then(function (res) {
						    if(res.data.result){
						    	alert('삭제 되었습니다.');
// 						    	history.back();
...
// 					location.href="<c:url value='/admin/promotion/image/"+ seq +".edit' />";
					$("#hiddenForm").attr('action', "<c:url value='/admin/promotion/image/"+ seq +".edit' />").submit();
