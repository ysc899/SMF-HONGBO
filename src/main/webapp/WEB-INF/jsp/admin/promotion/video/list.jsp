							...
							<tbody>
								<c:forEach var="item" items="${result.content }">
									<tr class="_row" data-seq="<c:out value="${item.seq }"/>">
										...
										<td><c:out value="${item.subTitle }"/></td>
...
// 				location.href="<c:url value='/admin/promotion/video/" + seq + ".view' />";
				$("#searchForm").attr('action', "<c:url value='/admin/promotion/video/" + seq + ".view' />").submit();
			});
...
// 					location.href="<c:url value='/admin/promotion/video/add.write' />";
					$("#searchForm").attr('action', "<c:url value='/admin/promotion/video/add.write' />").submit();
