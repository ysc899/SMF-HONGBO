...
// 				location.href="<c:url value='/admin/promotion/insp/" + seq + ".view' />";
				$("#searchForm").attr('action', "<c:url value='/admin/promotion/insp/" + seq + ".view' />").submit();
			});
...
// 					location.href="<c:url value='/admin/promotion/insp/add.write' />";
					$("#searchForm").attr('action', "<c:url value='/admin/promotion/insp/add.write' />").submit();
