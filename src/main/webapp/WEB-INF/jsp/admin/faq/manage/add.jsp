		...
		<div id="wrap">
			...
			<div id="container">
				...
				<div class="notice_area">
					<form id="addForm">
						<sec:csrfInput />
						<h1><img src="<c:url value='/admin/img/menu.svg'/>" alt="메뉴아이콘">통합 FAQ 등록</h1>
						<table>
							<colgroup>
								<col width="100px;"/>
								<col width="*;"/>
							...
							<tbody>
								...
								<tr>
									<th>FAQ 명</th>
									<td>
										<input type="text" class="form-control text_title" name="name" placeholder="등록될 FAQ명을 입력해주세요." id="name">
									</td>
								</tr>
								<tr>
									<th>FAQ 설명</th>
		...
		$(document).ready(function(){
			...
			$("#addForm").validate({
				...
				submitHandler: function(form) {
					...
					axios.post("<c:url value='/admin/faq/manage/addFaqManage.write' />", param)
					  .then(function (res) {
					    if(res.data.result > 0){
					    	alert('등록 되었습니다.');
//  					    	location.href="<c:url value='/admin/faq/manage/" + res.data.result + ".view' />";
 							$("#hiddenForm").attr('action', "<c:url value='/admin/faq/manage/" + res.data.result + ".view' />").submit();
