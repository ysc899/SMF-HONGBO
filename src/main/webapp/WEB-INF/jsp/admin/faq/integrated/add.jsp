		...
		$(document).ready(function(){
			...
			$("#addForm").validate({
				...
				submitHandler: function(form) {
					...
					axios.post("<c:url value='/admin/faq/integrated/${masterSeq}/addFaqIntegrated.write' />", param)
					  .then(function (res) {
					    if(res.data.result > 0){
					    	alert('등록 되었습니다.');
//  					    	location.href="<c:url value='/admin/faq/integrated/${masterSeq}/" + res.data.result + ".view' />";
							$("#hiddenForm").attr('action', "<c:url value='/admin/faq/integrated/${masterSeq}/" + res.data.result + ".view' />").submit();
