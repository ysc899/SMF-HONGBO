...
<!-- 	<meta name="X-UA-Compatible" content="IE=edge,chrome=1"/> -->
	...
	<link href="<c:url value='/user/css/02_sub01.css'/>" type="text/css" rel="stylesheet"/>
	...
	<div id="wrap">
		...
		<!--container-->
			<div id="container">
					...
					<div class="sub_story">
						<ul class="tabs">
							<li class="tab-link no_bottom _centerRow _centerMenu_1" data-tab="tab-1" ><spring:message code="search.all" /></li>
			...
			axios.get(url)
			  .then(function (res) {
				  ...
				  for(var idx in item.beforeHistory){
					  ...
					  var con = item.beforeHistory[idx].content;

					  con = con.replace('H. pylori', '<i>H. pylori</i> ');
