			...
			<div id="container">
					...
					<div class="sub_story">
						...
						<div class="sub_summury01" id="printDiv">
							...
							<p class="test_item_title"><c:out value="${result.f010fkn }"/></p>
							<table id="printArea">
								<colgroup>
									<col width="15%"/>
									<col width="40%"/>
								...
								<!--tr>
									<th class="th1">검사명</th>
									<td class="null_td" colspan="3"><c:out value="${result.f010fkn }"/></td>
								</tr-->
								<c:if test="${empty result.t001url}">
									<tr>
										<th>검사코드</th>
								...
								<c:if test="${not empty result.t001url}">
									<tr>
										<th>검사코드</th>
										<td class="td1"><c:out value="${result.f010gcd }"/></td>
										<th rowspan="2">학술제작물</th>
										<td rowspan="2">
											<img style="vertical-align: middle;" width="64" height="64" src='data:image/jpg;base64,<c:out value="${result.t001urlqr }"/>') />
											<a href="<c:out value="${result.t001url }"/>" target="_blank">E-Book 바로가기</a>
										</td>
									</tr>
									<tr>
										<th>검사방법</th>
								...
								<tr>
									<th class="th1">검사수가 (￦)<br><font color="blue" size="1px">*질가산료를 포함하지 않습니다.</font></br></th>
									<td class="td1">
									...
									<th>보존방법</th>
									<td class="null_td"><c:out value="${result.t001sav }"/>
									</td>
								</tr>
								<tr>
					...
					<div class="sub_summury01">
							<table id="printArea" style="border-top: 1px solid #ccc;">
								...
								<tbody>
								<tr>
									<th rowspan="2" style="border-bottom: 2px solid black;">검체 안정성</th>
									<td style="border-right: 1px solid #333; text-align: center; font-weight: 600; he">
									<b>실온</b></td>
									<td style="border-right: 1px solid #333; text-align: center; font-weight: 600;">냉장</td>
									<td class="null_td" style="text-align: center; font-weight: 600;"><b>냉동</b></td>
								</tr>
								<tr>
						...
						<div class="oneclick_page">
							<ul>
								<li id="btnPrint"><img src="<c:url value='/user/img/capsule/print.png'/>" alt="프린트아이콘"/>인쇄</li>
								<li class="_golist">목록으로</li>
							</ul>
						</div>
				</div>
					<!--//sub_story End-->
