					...
					<div class="sub_story">
						...
						<div id="tab-1" class="tab-content current">
							...
							<div class="inner_content4">
								...
								<p>factors that cause errors in test result</p>
							...
							<div class="inner_content3">
								...
								<table>
									...
									<tfoot>
										<tr>
											<td colspan="8">
												(*:Preservative essential, <img src="<c:url value='/user/img/sub/check_on.png'/>" alt="체크표시"/> : Recommended, <img src="<c:url value='/user/img/sub/check_on2.png'/>" alt="체크표시"/> : Possible)
											</td>
										</tr>
									</tfoot>
								</table>
						...
						<div id="tab-4" class="tab-content">
							...
							<div class="inner_content">
								...
								<p>General precautions for microbiological test</p>
								...
								<div class="sub_summury01_inner2">
									...
									<ul>
										<li><b>1.</b>Blood culture: 3 ~ 7 days (Final report takes 7 days)</li>
										<li><b>2.</b>Culture except blood: 2 ~ 3 days later</li>
										<li><b>3.</b>Culture of Mycobacterium tuberculosis: Interim report after 4 weeks (Final report 8 weeks)</li>
										<li><b>4.</b>Fungal culture: Interim report every week (Final report 3 Weeks)</li>
									</ul>
								</div>
								...
								<h1>Precautions for each specimen</h1>
								<h4>1. Urine</h4>
								<div class="sub_summury01_inner2">
									<ul>
								...
								<div class="sub_summury01_inner2">
									<ul>
										...
										<li><b>Blood:</b>The appropriate ratio of the medium to blood is from 1:5 to 1:10. Usually, 10 ml of blood is collected from
										...
										<tbody>
											<tr>
											  <th><b>Sputum</b></th>
											    <td>
											      <ul>
												    <li>Collect the first morning sputum once in a sterile container.</li>
												    <li>It is recommended to repeat the test for 2-3 consecutive days</li>
												    <li>Swab specimen is not appropriate for the cultivation of acid-fast bacterium. Due to the hydrophobicity of the acid-fast
												    bacterium, migration from the swab specimen to the medium is not easy, resulting in limited volume of specimen.</li>
												    <li>Pooled sputum, which is a collection of sputum, is not suitable due to increased contamination.</li>
											      </ul>
											   </td>
											</tr>
											...
											<tr>
											  ...
											  <td>
											    <ul>
												<li>Collect the midstream urine of the first morning urine in an aseptic container for 2~3 consecutive days</li>
												<li>For 24 hours urine, a small amount of urine is unsuitable.</li>
												<li>Collection with a catheter is only limited when the midstream urine cannot be obtained.</li>
											    </ul>
											  </td>
											</tr>
											
											<tr>
											  <th><b>Body fluid</b></th>
											  <td>
											    <ul>
												<li>Use Sodium polyanethol sulfonate (SPS) anticoagulant to collect the blood containing fluid.</li>
												<li>At least 5ml of cerebrospinal fluid is needed as it contains only a few acid-fast bacteria.</li>
											    </ul>
											  </td>
											</tr>
											
											<tr>
											  <th><b>Tissue, pus, etc.</b></th>
											  <td>
											    <ul>
												<li>Specimen exposed to formalin is unsuitable for smearing and culture.</li>
												<li>Tissues should not be placed in saline or wrapped with gauze, but the microscopic biopsy specimens can be
						...
						<div id="tab-5" class="tab-content">
							...
							<div class="inner_content">
								...
								<div class="sub_summury01_inner2">
									...
									<ul>
										<li>Avoid direct sunlight or hot places after sampling and dry naturally in a cool and dark place</li>
										<li>Allow to dry thoroughly for at least 3 to 4 hours</li>
									</ul>
								</div>
						...
						<div id="tab-6" class="tab-content">
							...
							<div class="inner_content">
								...
								<p>Precautions on gynecological test</p>
								<table>
									<tbody>
							...
							<div class="inner_content2">
								...
								<p>Smear sampling of cell specimen and how to request (process)</p>
								...
								<ul>
									...
									<li><b>4. </b>Take body fluid as much as possible (More than 10ml) (Pleural & Ascitic fluid, Urine, Bronchial washing etc.)
									</li>
						...
						<div id="tab-7" class="tab-content">
							...
							<div class="inner_content">
								...
								<ul>
									...
									<li style="margin-top:20px;"><b>Stomach biopsy tissue:</b> Attach the biopsy tissue to the filter paper by number and fix it in a bottle containing the fixative.</li>
								...
								<p>Prerequisite to histopathology request</p>
								<table>
									<tbody>
										<tr>
											<td class="n_td">1.</td>
							...
							<div class="inner_content">
								...
								<ul>
									<li><b>1. Precautions on Requesting Chromosome Test</b>
										<ul>
											<li><b>Amniotic fluid : </b> Discard the first two to three drops to prevent the maternal cell contamination</li>
