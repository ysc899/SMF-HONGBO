...
<!-- 	<meta name="X-UA-Compatible" content="IE=edge,chrome=1"/> -->
	...
	<link href="<c:url value='/user/css/06_sub04.css?20230131'/>" type="text/css" rel="stylesheet"/>
			  ...
			  for(var yearIdx in yearInfos){
				  ...
				  for(var keyIdx in sortKey){
					  ...
					  var monthIdx = sortKey[keyIdx];
						...
						historyContent +='	<tr>';
						if(CommonUtil.isEmpty(item.endYear)){
							historyContent +='	<th>'+monthIdx+'&nbsp;월</th>';
						}else{
							historyContent +='	<th class="h_1991">'+item.year +'&nbsp;년&nbsp;~&nbsp;'+ item.endYear+'&nbsp;년</th>';	
						}
						historyContent +='	<td>';
