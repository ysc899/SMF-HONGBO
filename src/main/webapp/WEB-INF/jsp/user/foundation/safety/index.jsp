...
<!-- 	<meta name="X-UA-Compatible" content="IE=edge,chrome=1"/> -->
	...
	<link href="<c:url value='/user/css/06_sub03.css?ver=20220913'/>" type="text/css" rel="stylesheet"/>
		...
		<!--container-->
			<div id="container">
					...
					<div class="sub_story">
						...
						<img src="/user/img/foundation/safety/safety_20231226.jpg" no-repeat 0 0; class="safety_img"></img>
<%--						<img src="/user/img/sub/vision_02.jpg" no-repeat 0 0; style="margin-left:-110px;"></img>--%>
