...
<!-- 	<meta name="X-UA-Compatible" content="IE=edge,chrome=1"/> -->
	...
	<link href="<c:url value='/user/css/04_sub04_en.css?ver=20230814'/>" type="text/css" rel="stylesheet"/>
	...
	<div id="wrap">
		...
		<!--container-->
			<div id="container">
					...
					<div class="sub_story">
						<ul class="tabs">
							<li style="width: 272px;" class="tab-link no_bottom _promoRow _bookMenuRow" data-tab="tab-0" data-category="all">ALL</li>
							<li style="width: 272px;" class="tab-link no_bottom _promoRow _bookMenuRow" data-tab="tab-1" data-category="news">Newsletter</li>
							<li style="width: 272px;" class="tab-link no_bottom _promoRow _bookMenuRow" data-tab="tab-2" data-category="leaflet">Leaflet</li>
							<li style="width: 272px;" class="tab-link no_bottom _promoRow _imageMenuRow" data-tab="tab-3" data-category="image">Info Video</li>
						</ul>
						
						<div id="tab-0" class="tab-content haksul01">
							<form id="allForm" onSubmit="return false;">
								<input type="hidden" name="currentPage" value="0" id="allCurrent"/>
								<input type="hidden" name="codeEbookCatType" value="all"/>
							</form>
						...
						<div id="tab-1" class="tab-content haksul01">
							<form id="newsForm" onSubmit="return false;">
								<input type="hidden" name="currentPage" value="0" id="newsCurrent"/>
								<input type="hidden" name="codeEbookCatType" value="news"/>
							</form>
							
							<div class="sil_box" id="newsList">
							
							</div>
							
							<div class="one_click_more_view _more" id="newsMore" data-category="news">
								<span><spring:message code="search.more" /></span><b>+</b>
							</div>
						...
						<div id="tab-2" class="tab-content haksul01 tab_common">
							<form id="leafletForm" onSubmit="return false;">
								<input type="hidden" name="currentPage" value="0" id="leafletCurrent"/>
								<input type="hidden" name="codeEbookCatType" value="leaflet"/>
							</form>

							<div class="sil_box" id="leafletList">

							</div>

							<div class="one_click_more_view _more" id="leafletMore" data-category="leaflet">
								<span><spring:message code="search.more" /></span><b>+</b>
							</div>
						</div>
...
<%-- 				  <source src="<c:url value='/admin/promotion/image/stream/${result.seq }.view'/>" type="video/mp4" /> --%>
	...
	<script type="text/javascript">
		...
		function getWebzineData(category){
...
// 					content += ' </b>';
		...
		$(document).ready(function(){
			...
			$("._more").click(function(){
				...
				if(category === 'news' || category === 'leaflet' || category === 'all'){
					getWebzineData(category);
				}else{
					getData(category);
				}
