...
<!-- 	<meta name="X-UA-Compatible" content="IE=edge,chrome=1"/> -->
	...
	<link href="<c:url value='/user/css/04_sub03_inner_en.css'/>" type="text/css" rel="stylesheet"/>
			...
			<div id="container">
					...
					<div class="sub_story">
						...
						<div id="oneclick_paper">
							<img src="<c:url value='/user/img/sub/en_covid_health_info_20220817.jpg'/>" style="max-width:1100px;" alt="원클릭이미지"/>
