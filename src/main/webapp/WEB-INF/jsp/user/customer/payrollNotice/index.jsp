						...
						<div class="notice_table">
							...
							<div class="n_right">
								...
								<select name="searchOption" id="search_select">
									<option value=""><spring:message code="search.all" /></option>
									<option value="title"><spring:message code="payrollNotice.option1" /></option>
									<option value="content"><spring:message code="payrollNotice.option2" /></option>
								</select>
							...
							<table>
								...
								<thead>
									<tr>
										<th><spring:message code="payrollNotice.list.row" /></th>
										<th><spring:message code="payrollNotice.list.title" /></th>
										<th><spring:message code="payrollNotice.list.date" /></th>
										<th><spring:message code="payrollNotice.list.count" /></th>
									</tr>
								</thead>
...
// 			};
			...
			$("._row").click(function(){
				...
				$("#searchForm").attr('action', "<c:url value='/customer/payrollNotice/" + seq + ".view' />").submit();
			});														
