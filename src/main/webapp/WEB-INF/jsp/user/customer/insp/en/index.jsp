...
<head>
	...
	<link href="<c:url value='/user/css/05_sub02_en.css?ver=20221209'/>" type="text/css" rel="stylesheet"/>
	...
	<div id="container">
		...
		<div class="sub_story">
			<ul class="tabs" style="display:none;">
				<li class="tab-link no_bottom _promoRow _videoMenuRow" data-tab="tab-2" data-category="video">PR Video</li>
				<li class="tab-link no_bottom _promoRow _bookMenuRow" data-tab="tab-1" data-category="book">PR Brochure</li>
			</ul>
			...
			<div id="tab-1" class="tab-content haksul01">
				...
				<div class="sil_box" id="bookList_en">

					<div class="brochure_wrap" style="margin:50px 0 120px 0;">
						<ul>
							<li>
								<img src="/user/img/brosure.png" class="brochure_en"
									 onclick="window.open('https://www.seegenemedical.com/e-book/ecatalog5.jsp?Dir=182&catimage=&callmode=admin')"></img>
			...
			<div id="tab-2" class="tab-content haksul02 tab_common">
				...
				<div class="sil_box" id="videoList_en">

					<div class="movie_wrap" style="margin:50px 0 120px 0;">
						<div class="movie_inner">

<%--							<iframe width="560" height="315" src="https://www.youtube.com/embed/GXO81kKBt0s" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>--%>
							<iframe width="746" height="420" src="https://www.youtube.com/embed/AQ4enltltfM" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
