...
<!-- 	<meta name="X-UA-Compatible" content="IE=edge,chrome=1"/> -->
	...
	<link href="<c:url value='/user/css/04_sub03_inner2.css?ver=20230721'/>" type="text/css" rel="stylesheet"/>
								...
								<thead></thead>
									<tbody>
										<tr>
											...
											<td>
												<c:out value="${result.inspector }"/><br/><c:out value="${result.inspectorCmt }"/>
											</td>
