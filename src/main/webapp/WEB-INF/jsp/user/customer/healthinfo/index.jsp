...
<!-- 	<meta name="X-UA-Compatible" content="IE=edge,chrome=1"/> -->
	...
	<link href="<c:url value='/user/css/04_sub03.css?ver=20230721'/>" type="text/css" rel="stylesheet"/>
												...
												<tbody>
													<tr>
														...
														<td class="td_2 sil">
															...
															<b class="_row" data-seq="<c:out value='${item.seq }' />">등록일 : <fmt:formatDate pattern = "yyyy년 MM월 dd일" value = "${item.regDate}" /></b>
														</td>
													</tr>
												</tbody>
											</table>
					...
					axios.get(url,{
					  ...
					  .then(function (res) {
						  ...
						  for(var idx = 0; idx < res.data.result.length ; idx++){
							...
							content += '				<b class="_row" data-seq="' + item.seq +'">등록일 : '+ moment(item.regDate).format('YYYY년 MM월 DD일') +'</b>';
							content += '			</td>';
							content += '		</tr>';
							content += '	</table>';
							content += '</li>';
