...
//	private static String DEFAULT_FILE_PATH;
	...
	private final static String FILE_TEMP_DIR = "cnvFile";
...
//				if (mFile.getSize() > 0) {
//
//					status = getMultipartFileDocToPdf(targetPdf, mFile);
//				}
//			}
...
//	}
//
//	public static boolean getMultipartFileDocToPdf(String targetPdf, MultipartFile mFile) throws IOException, ConnectException {
//		boolean status;
//		//Write File 이후 Move File????
//		String newName = "";
//		String stordFilePath = EgovProperties.getProperty("fileUpload.path")+ File.separator + FILE_TEMP_DIR + File.separator;
////		String stordFilePath = DEFAULT_FILE_PATH + File.separator + FILE_TEMP_DIR + File.separator;
//		
